...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function oe(){return ee=ee||new ne}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ComponentFixture=i,e.ComponentFixtureAutoDetect=D,e.ComponentFixtureNoNgZone=S,e.InjectSetupWrapper=ve,e.TestBed=pe,e.TestComponentRenderer=P,e.__core_private_testing_placeholder__="",e.async=function ye(e){var t="undefined"!=typeof Zone?Zone:null;if(!t)return function(){return Promise.reject("Zone is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/zone.js")};var r=t&&t[t.__symbol__("asyncTest")];return"function"==typeof r?r(e):function i(e){return n.jasmine?function(t){t||((t=function(){}).fail=function(e){throw e}),o(e,this,t,(function(e){if("string"==typeof e)return t.fail(new Error(e));t.fail(e)}))}:function(){var t=this;return new Promise((function(r,n){o(e,t,r,n)}))}}(e)},e.discardPeriodicTasks=function ge(){if(v)return v.discardPeriodicTasks();!function e(){d().pendingPeriodicTimers.length=0}()},e.fakeAsync=function _e(e){return v?v.fakeAsync(e):function t(e){return function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];var n=c.assertPresent();if(p)throw new Error("fakeAsync() calls can not be nested");p=!0;try{if(!l){if(n.getDelegate()instanceof u)throw new Error("fakeAsync() calls can not be nested");l=new u}var o=void 0,i=n.getDelegate();n.setDelegate(l);try{o=e.apply(this,t),h()}finally{n.setDelegate(i)}if(l.pendingPeriodicTimers.length>0)throw new Error(l.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(l.pendingTimers.length>0)throw new Error(l.pendingTimers.length+" timer(s) still in the queue.");return o}finally{p=!1,a()}}}(e)},e.flush=function Me(e){return v?v.flush(e):function t(e){return d().flush(e)}(e)},e.flushMicrotasks=function Oe(){return v?v.flushMicrotasks():h()},e.getTestBed=de,e.inject=fe,e.resetFakeAsyncZone=m,e.tick=function be(e){return void 0===e&&(e=0),v?v.tick(e):function t(e){void 0===e&&(e=0),d().tick(e)}(e)},e.withModule=function Te(e,t){return t?function(){var r=de();return e&&r.configureTestingModule(e),t.apply(this)}:new ve((function(){return e}))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */,e.ɵMetadataOverrider=x,e.ɵTestingCompiler=ue,e.ɵTestingCompilerFactory=ce,e.ɵangular_packages_core_testing_testing_a=ae,e.ɵangular_packages_core_testing_testing_b=ne,e.ɵangular_packages_core_testing_testing_c=oe,Object.defineProperty(e,"__esModule",{value:!0})}));