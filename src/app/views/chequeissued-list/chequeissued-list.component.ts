...
@Component({
  selector: 'app-chequeissued-list',
  templateUrl: './chequeissued-list.component.html',
  styleUrls: ['./chequeissued-list.component.css']
})
export class ChequeissuedListComponent implements OnInit {
